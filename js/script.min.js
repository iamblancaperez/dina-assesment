...
$(document).ready(function($) {
	...
	// adding routes
	Router
	.add(/dina-assesment(.*)\/edit/, function() {
	...
	.add(/dina-assesment\/new/, function() {
		var user = new User("");
		user.renderForm(mainContainer);
	})
	.add(/dina-assesment\/overview/, function() {
		mainContainer.innerHTML = "";
	})
	.add(/dina-assesment\/sites/, function() {
		mainContainer.innerHTML = "";
	})
	.add(/dina-assesment\/payments/, function() {
		mainContainer.innerHTML = "";
	})
	.add(function() {
		mainContainer.innerHTML = "";
	...
	createUser.addEventListener('click',function(e){
		e.preventDefault();
		Router.check('/dina-assesment/new').listen();
	});
			...
			if(response.success){
				if(action == "create"){
					createUser({"first_name" : realThis.firstName, "last_name" : realThis.lastName, "status" : realThis.status}).then(function(user){
						Router.navigate(`/dina-assesment/${user.id}/edit`);
					});
				}else if(action == "edit"){
